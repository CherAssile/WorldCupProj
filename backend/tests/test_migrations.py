...
# CLAUDE.md annonce 15 tables ; training_session_matches (tirage avant pronostic, absente
# de la répartition par catégorie du document) porte le compte réel à ce total.
