...
- `matches` : matchs du tournoi en cours (mode compétitif).
...
- Score pronostiqué : temps réglementaire (90 min + arrêts), hors prolongation/tab.
- Barème : score exact 3 pts, issue correcte 1 pt, x2 à partir des quarts. Récompense
  correcte 5 pts. Même barème pour l'entraînement (mais hors classement).
